...
$moder_group = "moder";    // Название группы PEX с правами модераторов
...
$debug = 2;    // Включить вывод ошибок. Выключить после полной настройки скрипта! Для вывода отдельных ошибок: 1 - Все ошибки, 2 - критические, 3 - все, кроме NOTICE(желательно)
...
$not_allowed_groups = array('moder');    // Группы PEX, которым нельзя заполнять анкету.
...
$min_regdate = 14;    // Минимальное количество дней назад, когда игрок зарегистрировался. Для отключения впишите 0
