...
// Таблицы
$users_tbl = "dle_users";    // Таблица с аккаунтами пользователей
...
$debug = 2;    // Поставить FALSE после полной настройки скрипта! Вывод ошибок: 1 - Все ошибки, 2 - критические, 3 - все, кроме NOTICE(желательно во время отладки)
...
$max_for_vote = 40;    // Максимальное количество голосований "За" для игрока
$max_against_vote = 40;    // Максимальное количество голосований "Против" для игрока
...
$send_mail = true;    //  Отсылать письмо при изменении статуса заявки
$site_name = "domain.ru";	//
$script_url = "http://domain.ru/jointeam.html";    //
