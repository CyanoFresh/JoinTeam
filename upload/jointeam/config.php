...
$debug = 1;    // Поставить FALSE после полной настройки скрипта! Вывод ошибок: 1 - Все ошибки, 2 - критические, 3 - все, кроме NOTICE(желательно во время отладки)
...
$admin_groups = array(1);    // ID Группы DLE, которым разрешен вход в админку
